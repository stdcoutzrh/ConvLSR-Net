...
def parse_args():
    ...
    parser.add_argument("--input-dir", default="/Users/peco/datasets/uavid/uavid_train")
    parser.add_argument("--output-img-dir", default="/Users/peco/datasets/uavid/train_patches/images")
    parser.add_argument("--output-mask-dir", default="/Users/peco/datasets/uavid/train_patches/masks")
