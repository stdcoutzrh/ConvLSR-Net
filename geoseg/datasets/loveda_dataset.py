...
class LoveDATrainDataset(Dataset):
    def __init__(self, data_root='/home/zrh/datasets/loveda/train', img_dir='images_png', mosaic_ratio=0.25,
...
loveda_val_dataset = LoveDATrainDataset(data_root='/home/zrh/datasets/semantic/loveda/val', mosaic_ratio=0.0,
                                        transform=val_aug)


class LoveDATestDataset(Dataset):
    def __init__(self, data_root='/home/zrh/datasets/semantic/loveda/test', img_dir='images_png',
